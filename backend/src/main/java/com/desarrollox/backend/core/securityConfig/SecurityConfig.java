...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/api/purchases/soft-delete-cliente/{id}")
                        .hasRole("CLIENTE")
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/sections/{id}").hasRole("ADMIN")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(java.util.List.of("https://strangerdrug2.com"));
